...
if(isset($_POST['page'])){ 
    ...
    $query   = $conn->query("SELECT COUNT(*) as rowNum FROM oanda_db WHERE 1 $searchQuery"); 
    ...
    $query = $conn->query("SELECT * FROM oanda_db WHERE 1 $searchQuery ORDER BY id ASC LIMIT $offset, $limit"); 
